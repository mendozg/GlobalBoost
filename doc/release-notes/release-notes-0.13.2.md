GlobalBoost Core version 0.13.2 is now available from:

  <https://globalboost.org/bin/globalboost-core-0.13.2/>
...
- #8908 `4a974b2` Update globalboost-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow globalboost-tx to create v2 transactions (bstydrak)
