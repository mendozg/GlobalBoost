...
This document provides guidelines for internationalization of the GlobalBoost Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `globalboost_en.ts` remains unchanged.
