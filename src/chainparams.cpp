...
// Copyright (c) 2014-2019 The GlobalBoost Core developers
...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000000007381076763ef");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.globalboost.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tbsty.petertodd.org");
