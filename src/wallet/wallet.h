...
#ifndef GLOBALBOOST_WALLET_WALLET_H
#define GLOBALBOOST_WALLET_WALLET_H
...
public:
     ...
     * on this globalboost node, and set to 0 for transactions that were created
...
#endif // GLOBALBOOST_WALLET_WALLET_H
