...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<GlobalBoostAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_globalboost-qt -platform xcb      # Linux
//     src/qt/test/test_globalboost-qt -platform windows  # Windows
//     src/qt/test/test_globalboost-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = GlobalBoostUnits::formatWithUnit(unit, balance, false, GlobalBoostUnits::separatorAlways);
    ...
    // Amount input
    GlobalBoostAmountField* amountInput = receiveCoinsDialog.findChild<GlobalBoostAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: globalboost:")) != -1);
