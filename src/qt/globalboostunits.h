...
#ifndef GLOBALBOOST_QT_GLOBALBOOSTUNITS_H
#define GLOBALBOOST_QT_GLOBALBOOSTUNITS_H
...
/** GlobalBoost unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GlobalBoostUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GlobalBoostUnits(QObject *parent);

    /** GlobalBoost units.
      @note Source: https://en.globalboost.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BSTY,
...
typedef GlobalBoostUnits::Unit GlobalBoostUnit;

#endif // GLOBALBOOST_QT_GLOBALBOOSTUNITS_H
