...
QString GlobalBoostUnits::name(int unit)
{
    switch(unit)
    {
    case BSTY: return QString("BSTY");
    case mBSTY: return QString("mBSTY");
    case uBSTY: return QString::fromUtf8("μBSTY");
...
QString GlobalBoostUnits::description(int unit)
{
    ...
    case uBSTY: return QString("Micro-GlobalBoosts (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
QString GlobalBoostUnits::getAmountColumnTitle(int unit)
{
    ...
    {
        amountTitle += " ("+GlobalBoostUnits::name(unit) + ")";
    }
    return amountTitle;
}
