...
#ifndef GLOBALBOOST_TEST_SCRIPTNUM10_H
#define GLOBALBOOST_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from GlobalBoost Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // GLOBALBOOST_TEST_BIGNUM_H
