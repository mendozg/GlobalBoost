...
# TestNode: A peer we use to send messages to globalboostd, and store responses.
...
class CompactBlocksTest(GlobalBoostTestFramework):
    ...
    # This test actually causes globalboostd to (reasonably!) disconnect us, so do this last.
    ...
    # globalboostd's choice of nonce.
    ...
    # Test that globalboostd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for globalboostd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # globalboostd will not send blocktxn responses for blocks whose height is
