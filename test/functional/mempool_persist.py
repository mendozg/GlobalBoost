...
By default, globalboostd will dump mempool on shutdown and
...
class MempoolPersistTest(GlobalBoostTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give globalboostd a second to reload the mempool
        ...
        self.log.debug("Prevent globalboostd from writing mempool.dat to disk. Verify that `savemempool` fails")
